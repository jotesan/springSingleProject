...
<html>
<head>
<title>Update incidence incidenceType</title>
<!-- Bootstrap -->
<link
...
<body>
	...
	<h1>
		<s:message code="updateIncidenceType"></s:message>
	</h1>
	<s:url var="action" value="/incidenceTypes/saveupdate" />
	<sf:form id="updateIncidenceTypeForm" method="post" action="${action}"
		modelAttribute="incidenceType">
		<sf:hidden path="id" />
	...
	<script src="<c:url value="/resources/js/validateIncidenceTypeUpdateForm.js" />"></script>
</body>
</html>
